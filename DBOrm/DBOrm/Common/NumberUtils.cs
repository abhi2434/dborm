...
namespace DBOrm.Common
{
    public class NumberUtils
    {
        ...
        {
            Regex notNaturalPattern = new Regex(RegexPattern.NOT_NATURAL_NUM);
            Regex naturalPattern = new Regex(RegexPattern.NATURAL_NUM);
        ...
        {
            Regex notWholePattern = new Regex(RegexPattern.NOT_NATURAL_NUM);
        ...
        {
            Regex notIntPattern = new Regex(RegexPattern.NOT_INT);
            Regex intPattern = new Regex(RegexPattern.INT);
